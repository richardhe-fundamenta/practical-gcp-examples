...
from analytics_agent.utils.gcs import create_bucket_if_not_exists
from analytics_agent.utils.tracing import CloudTraceLoggingSpanExporter
from analytics_agent.utils.typing import Feedback
...
def deploy_agent_engine_app(
    ...
    extra_packages: list[str] = ["./analytics_agent"],
    ...
    artifacts_bucket_name = f"{project}-adk-agent-billing-logs-data"
