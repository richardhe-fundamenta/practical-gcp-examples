...
(
  ...
  JSON '[{"name": "year", "type": "int64", "description": "The year to query (1910-current)", "required": true}]',
  true,
  CURRENT_TIMESTAMP(),
  CURRENT_TIMESTAMP(),
...
(
  ...
  JSON '[{"name": "start_year", "type": "int64", "description": "Start year", "required": true}, {"name": "end_year", "type": "int64", "description": "End year", "required": true}]',
  true,
  CURRENT_TIMESTAMP(),
  CURRENT_TIMESTAMP(),
  'analytics-team@example.com',
...
(
  ...
  JSON '[{"name": "start_date", "type": "string", "description": "Start date (YYYY-MM-DD)", "required": true}, {"name": "end_date", "type": "string", "description": "End date (YYYY-MM-DD)", "required": true}, {"name": "top_n", "type": "int64", "description": "Number of top tags to return", "required": true, "default": 20}]',
  true,
  CURRENT_TIMESTAMP(),
  CURRENT_TIMESTAMP(),
...
(
  ...
  JSON '[{"name": "tag", "type": "string", "description": "Tag to search for (e.g., python, javascript)", "required": true}, {"name": "limit", "type": "int64", "description": "Maximum number of results", "required": true, "default": 100}]',
  true,
  CURRENT_TIMESTAMP(),
  CURRENT_TIMESTAMP(),
  'ops-team@example.com',
...
(
  ...
  JSON '[{"name": "user_id", "type": "int64", "description": "Stack Overflow user ID", "required": true}]',
  true,
  CURRENT_TIMESTAMP(),
  CURRENT_TIMESTAMP(),
  'ops-team@example.com',
...
(
  ...
  JSON '[{"name": "min_year", "type": "int64", "description": "Minimum year to include", "required": true}, {"name": "min_year_count", "type": "int64", "description": "Minimum number of years name must appear", "required": true, "default": 10}]',
  true,
  CURRENT_TIMESTAMP(),
  CURRENT_TIMESTAMP(),
  'ml-team@example.com',
...
(
  ...
  JSON '[{"name": "hours_ago", "type": "int64", "description": "Number of hours to look back", "required": true, "default": 24}]',
  true,
  CURRENT_TIMESTAMP(),
  CURRENT_TIMESTAMP(),
  'admin-team@example.com',
